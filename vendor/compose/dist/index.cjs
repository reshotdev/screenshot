...
__export(src_exports, {
  ...
  DEFAULT_FRAME_BAR_H: () => DEFAULT_FRAME_BAR_H,
  DEFAULT_FRAME_VIDEO: () => DEFAULT_FRAME_VIDEO,
  DEFAULT_SOURCE: () => DEFAULT_SOURCE,
  FocusPath: () => FocusPath,
  Fragment: () => Fragment,
  Frame: () => Frame,
  ProductFilm: () => ProductFilm,
  Scene: () => Scene,
  buildSceneCameraScript: () => buildSceneCameraScript,
  buildSceneMotionScript: () => buildSceneMotionScript,
  compile: () => compile,
  ...
  jsxDEV: () => jsxDEV,
  jsxs: () => jsxs,
  resolveBeatTiming: () => resolveBeatTiming,
  solveSceneCameraFromContext: () => solveSceneCameraFromContext,
  solveSceneCameraPath: () => solveSceneCameraPath,
  solveSceneMotion: () => solveSceneMotion,
  solveSceneMotionFromContext: () => solveSceneMotionFromContext,
...
var import_motion_core = require("@reshot/motion-core");
...
function solveProductFilmCameraPath(steps, workflow, options = {}) {
  ...
  const solved = (0, import_motion_core.solveCameraPath)({
    steps: solverInput,
