...
async function writeProof(opts) {
  await mkdir4(opts.outDir, { recursive: true });
  const htmlPath = join2(opts.outDir, "index.html");
  await writeFile4(htmlPath, renderProofHtml(opts), "utf8");
  return htmlPath;
}
...
//# sourceMappingURL=auto-update.mjs.map